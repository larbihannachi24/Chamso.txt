...
def uaku():
	try:
		...
		a=requests.get('https://github.com/larbihannachi24/Chamso24.txt').text
		ua=open('.bbnew.txt','w')
...
logo=("""
 ...
 dP""b8 88  88    db    8b    d8 .dP"Y8  dP"Yb  
dP   `" 88  88   dPYb   88b  d88 `Ybo." dP   Yb 
Yb      888888  dP__Yb  88YbdP88 o.`Y8b Yb   dP 
 YboodP 88  88 dP""""Yb 88 YY 88 8bodP'  YbodP  
\x1b[1;91m---------------------------------------
